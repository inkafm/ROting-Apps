...
import 'package:topology_app/widgets/topology_widgets/question_dinamic_topology_3/dinamic_3_question_1.dart';
import 'package:topology_app/widgets/topology_widgets/question_dinamic_topology_3/dinamic_3_question_2.dart';
import 'package:topology_app/widgets/topology_widgets/question_dinamic_topology_3/dinamic_3_question_3.dart';

class DinamicTopology3 extends StatefulWidget {
  const DinamicTopology3({super.key});

  @override
  State<DinamicTopology3> createState() => _DinamicTopology3State();
}

class _DinamicTopology3State extends State<DinamicTopology3> {
  ...
  Widget build(BuildContext context) {
    ...
    switchQuestion(question_number) {
      switch (question_number) {
        case 1:
          return Dinamic3Question1();
          break;
        case 2:
          return Dinamic3Question2();
          break;
        case 3:
          return Dinamic3Question3();
          break;
        default:
          return Container(
            child: Center(
