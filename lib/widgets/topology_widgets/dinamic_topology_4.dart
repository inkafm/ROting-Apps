...
import 'package:topology_app/widgets/topology_widgets/question_dinamic_topology_4/dinamic_4_question_1.dart';
import 'package:topology_app/widgets/topology_widgets/question_dinamic_topology_4/dinamic_4_question_2.dart';
import 'package:topology_app/widgets/topology_widgets/question_dinamic_topology_4/dinamic_4_question_3.dart';

class DinamicTopology4 extends StatefulWidget {
  const DinamicTopology4({super.key});

  @override
  State<DinamicTopology4> createState() => _DinamicTopology4State();
}

class _DinamicTopology4State extends State<DinamicTopology4> {
  ...
  Widget build(BuildContext context) {
    ...
    switchQuestion(question_number) {
      switch (question_number) {
        case 1:
          return Dinamic4Question1();
          break;
        case 2:
          return Dinamic4Question2();
          break;
        case 3:
          return Dinamic4Question3();
          break;
        default:
          return Container(
            child: Center(
