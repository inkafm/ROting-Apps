...
import 'package:topology_app/widgets/topology_widgets/question_dinamic_topology_5/dinamic_5_question_1.dart';
import 'package:topology_app/widgets/topology_widgets/question_dinamic_topology_5/dinamic_5_question_2.dart';
import 'package:topology_app/widgets/topology_widgets/question_dinamic_topology_5/dinamic_5_question_3.dart';
import 'package:topology_app/widgets/topology_widgets/question_dinamic_topology_5/dinamic_5_question_4.dart';

class DinamicTopology5 extends StatefulWidget {
  const DinamicTopology5({super.key});

  @override
  State<DinamicTopology5> createState() => _DinamicTopology5State();
}

class _DinamicTopology5State extends State<DinamicTopology5> {
  ...
  late List questions = [
    ...
    "Lalu tunjukkan alamat jaringan yang dimasukkan oleh administrator untuk menkonfigurasi router 4!"
  ];
  ...
  Widget build(BuildContext context) {
    ...
    switchQuestion(question_number) {
      switch (question_number) {
        case 1:
          return Dinamic5Question1();
          break;
        case 2:
          return Dinamic5Question2();
          break;
        case 3:
          return Dinamic5Question3();
          break;
        case 4:
          return Dinamic5Question4();
          break;
        default:
          return Container(
            child: Center(
