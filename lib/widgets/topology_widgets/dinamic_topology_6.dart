...
import 'package:topology_app/widgets/topology_widgets/question_dinamic_topology_6/dinamic_6_question_1.dart';
import 'package:topology_app/widgets/topology_widgets/question_dinamic_topology_6/dinamic_6_question_2.dart';
import 'package:topology_app/widgets/topology_widgets/question_dinamic_topology_6/dinamic_6_question_3.dart';
import 'package:topology_app/widgets/topology_widgets/question_dinamic_topology_6/dinamic_6_question_4.dart';

class DinamicTopology6 extends StatefulWidget {
  const DinamicTopology6({super.key});

  @override
  State<DinamicTopology6> createState() => _DinamicTopology6State();
}

class _DinamicTopology6State extends State<DinamicTopology6> {
  ...
  Widget build(BuildContext context) {
    ...
    switchQuestion(question_number) {
      switch (question_number) {
        case 1:
          return Dinamic6Question1();
          break;
        case 2:
          return Dinamic6Question2();
          break;
        case 3:
          return Dinamic6Question3();
          break;
        case 4:
          return Dinamic6Question4();
          break;
        default:
          return Container(
            child: Center(
