...
class Topology2Question2 extends StatefulWidget {
  const Topology2Question2({super.key});

  @override
  State<Topology2Question2> createState() => _Topology2Question2State();
}

class _Topology2Question2State extends State<Topology2Question2> {
  bool point1 = false;
  bool wrong1 = false;
  bool wrong2 = false;
  bool wrong3 = false;
