...
class Topology2Question4 extends StatefulWidget {
  const Topology2Question4({super.key});

  @override
  State<Topology2Question4> createState() => _Topology2Question4State();
}

class _Topology2Question4State extends State<Topology2Question4> {
  bool point1 = false;
  bool wrong1 = false;
  bool wrong2 = false;
  bool wrong3 = false;
