...
class StaticTopology1 extends StatefulWidget {
  const StaticTopology1({super.key});

  @override
  State<StaticTopology1> createState() => _StaticTopology1State();
}

class _StaticTopology1State extends State<StaticTopology1> {
